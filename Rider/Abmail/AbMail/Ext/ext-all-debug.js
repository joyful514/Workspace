...
Ext.kCalendar = function(config){
    Ext.kCalendar.superclass.constructor.call(this, config);
...
Ext.extend(Ext.kCalendar, Ext.Component, {
...
Ext.reg('kCalendar', Ext.kCalendar);
...
Ext.menu.DateItem = function(config){
    Ext.menu.DateItem.superclass.constructor.call(this, new Ext.kCalendar(config), config);
