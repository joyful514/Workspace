<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeBehind="UserEdit.aspx.cs" Inherits="AbMail.Admin.UserEdit" %>
    ...
    <div style="background: #fafafa; padding: 10px;" id="add">
        <div>
            <div>
                ...
                <asp:TextBox ID="txtUserName" runat="server" class="easyui-validatebox"></asp:TextBox>
            </div>
        </div>
        <div>
            <label for="name">
            ...
            <asp:TextBox ID="txtPwd" runat="server" class="easyui-validatebox" Text="" TextMode="Password"></asp:TextBox>为空不改变
        </div>
        <div>
