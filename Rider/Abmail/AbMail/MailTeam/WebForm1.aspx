<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="AbMail.MailTeam.WebForm1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="div01">
            ...
            <fieldset style="width: 100%;">
                ...
                <asp:Button ID="btnSaveStrategy" runat="server" Text="Save" OnClientClick="clientSave();" OnClick="btnSaveStrategy_Click" /><br />
            ...
            <div>
                ...
                <asp:ObjectDataSource ID="Ods" runat="server" SelectMethod="GetDataByPager2005" EnablePaging="True"
                    ...
                    <SelectParameters>
                        ...
                        <asp:Parameter Name="where" DefaultValue=" 1=1 and unsubscribe=0 " Type="String" />
